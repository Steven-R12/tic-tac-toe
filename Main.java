...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("Young Thug "+ game.board.winner());
            if (game.board.winner().equals("X")||(game.board.winner().equals("O"))) {
                ...
                System.out.println("No Points CUhh, Its a draw!");
            }
            ...
            if (resp.equals("N")){
                System.out.println("Word good game!");
                break;
            } else {
                System.out.println("Das not an answer, Respond with (Y/N)");
                break;
            }
            }
        }
